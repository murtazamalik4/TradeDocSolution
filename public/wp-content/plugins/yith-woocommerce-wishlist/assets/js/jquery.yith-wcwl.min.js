jQuery(function(d) {
    ...
    function o() {
        yith_wcwl_l10n.enable_tooltip && d(".yith-wcwl-add-to-wishlist").find("[data-title]").each(function() {
            ...
            t.hasClass("tooltip-added") || (t.on("mouseenter", function() {
                ...
                e.append(i), t = i.outerWidth() + 6, i.outerWidth(t), a = (n - t) / 2, i.css({
                    left: a.toFixed(0) + "px"
    ...
    function w() {
        d(".copy-trigger").on("click", function() {
            var t = d(".copy-target");
            0 < t.length && (t.is("input") ? (s() ? t[0].setSelectionRange(0, 9999) : t.select(), document.execCommand("copy")) : (t = d("<input/>", {
                val: t.text(),
                type: "text"
            }), d("body").append(t), s() ? t[0].setSelectionRange(0, 9999) : t.select(), document.execCommand("copy"), t.remove()))
        })
    }
    ...
    function v(t) {
        ...
        n = n || d("#wishlist_id").val(), e = {
            ...
            success: function(t) {
                var e = t.fragments;
                t.result ? (i.hide(), i.prev().find(".wishlist-anchor, h1, h2").text(o).end().show()) : (i.addClass("woocommerce-invalid"), a.focus()), void 0 !== e && O(e)
            }
        })
    }
        ...
        if ("undefined" != typeof d.prettyPhoto && "undefined" != typeof d.prettyPhoto.close)
            if (void 0 !== t) {
                ...
                o.length && ((i = d("<div/>", {
                    ...
                    "class": "feedback",
                    html: t
                })), i.css("display", "none"), a.css("height", "auto"), o.after(i), o.fadeOut(200, function() {
                    i.fadeIn()
                }), n.addClass("feedback"), n.css("left", d(window).innerWidth() / 2 - n.outerWidth() / 2 + "px"), "undefined" != typeof yith_wcwl_l10n.auto_close_popup && !yith_wcwl_l10n.auto_close_popup || setTimeout(b, yith_wcwl_l10n.popup_timeout))
            } else try {
                d.prettyPhoto.close()
            } catch (s) {}
    }
    ...
    d(document).on("yith_wcwl_init", function() {
        ...
        t.on("click", ".add_to_wishlist", function(t) {
            ...
            if ((i = d(document).triggerHandler("yith_wcwl_add_to_wishlist_data", [n, o])) && (o = i), t.preventDefault(), jQuery(document.body).trigger("adding_to_wishlist"), yith_wcwl_l10n.multi_wishlist && yith_wcwl_l10n.modal_enable) {
            ...
            return t.action = yith_wcwl_l10n.actions.ask_an_estimate, t.nonce = yith_wcwl_l10n.noce.ask_an_estimate_nonce, t.context = "frontend", d.ajax({
                beforeSend: function() {
                    j(i)
                },
                complete: function() {
            ...
            e.addClass("active").siblings(".show-tab").removeClass("active"), a.show().siblings(".tab").hide(), "create" === n ? i.prepend('<input type="hidden" id="new_wishlist_selector" class="wishlist-select" value="new">') : i.find("#new_wishlist_selector").remove()
            ...
            var t = d(".wishlist_table.responsive"),
                ...
                s = {},
                n = !1;
            t.length && (i.matches && t && !e ? (o.is_mobile = "yes", n = !0) : !i.matches && t && e && (o.is_mobile = "no", n = !0), n && (l && l.abort(), s[a.split(" ").join(yith_wcwl_l10n.fragments_index_glue)] = o, l = d.ajax({
                beforeSend: function() {
                    j(t)
                },
                complete: function() {
