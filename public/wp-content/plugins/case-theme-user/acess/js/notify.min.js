(function(e) {
    ...
    L.prototype.loadHTML = function() {
        ...
        return e(this).each(function() {
            var i;
            return i = T(e(this)).data(r), i ? i.run(t, n) : new L(e(this), t, n)
        }), this
    }, e.extend(e[n], {
        defaults: E,
        addStyle: v,
        ...
        return m(h.css).attr("id", "core-notify"), e(document).on("click", "." + r + "-hidable", function(t) {
            return e(this).trigger("notify-hide")
